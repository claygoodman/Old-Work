...
CREATE TABLE [dbo].[consldatr_transactions](
	[partn_key] [int] NOT NULL,
	[CONSLDATR_PARTN_KEY] [int] NOT NULL,
...
ALTER TABLE [dbo].[consldatr_transactions] 
ADD CONSTRAINT PK_consldatr_transactions PRIMARY KEY CLUSTERED 
(
	[partn_key] ASC,
	[CONSLDATR_ID] ASC,
	...
	[trans_crtd_dttm] ASC
)WITH FILLFACTOR = 90 ON [con_trans]
