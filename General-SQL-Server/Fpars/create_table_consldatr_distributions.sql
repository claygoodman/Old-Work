...
--RENAME THE VIEW
EXEC sp_rename 'consldatr_distributions', 'consldatr_distributions_old'

CREATE TABLE [dbo].[consldatr_distributions](
	[consdist_ID] [INT] IDENTITY(1,1) NOT NULL,
...
INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2008_Q1]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2008_Q2]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2008_Q3]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2008_Q4]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2009_Q1]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2009_Q2]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2009_Q3]	

INSERT INTO [dbo].[consldatr_distributions]
	SELECT * 
	FROM [Fpars].[dbo].[consldatr_distributions_2009_Q4]	
...
(consdist_id) ON [con_dist]

GO

ALTER DATABASE [Fpars] ADD FILEGROUP [cmn_idx1]
GO
--CHANGE THE FILE LOCATION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
ALTER DATABASE [Fpars] ADD FILE (NAME = 'cmn_idx1', FILENAME = 'C:\SQL_Data\cmn_idx1.NDF', SIZE = 2, FILEGROWTH = 10%) TO FILEGROUP [cmn_idx1]
GO


CREATE UNIQUE INDEX ncls_consdist_cnstr ON consldatr_distributions
(
	[PARTN_KEY] ASC,
	[CONSLDATR_ID] ASC,
	[CONSLDATR_ID_SRC] ASC,
	[CONSLDATRDISB_SEQUENCE] ASC
)WITH FILLFACTOR = 90 ON [cmn_idx1]
